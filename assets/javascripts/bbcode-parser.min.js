(function (global, factory) {
    ...
    */
    ...
    function parseBody(body, tag) {
        if((!tag || tag === "") || (!body || body === "")) return false;
        ...
        switch(tag) {
            case "[img]":
                return body.replace(regexExpressions, '<img src="$1" data-url="$1" />');
        }
    }
    ...
    function heightrestrict(node) {
        ...
        const parsedBody = parseBody("[img]");
        ...
        //return toNode("span", { class: "bbImageWrapper", style: `height: ${input}px` }, node.content);
    };
