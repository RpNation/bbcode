(function (global, factory) {
    ...
    */
    ...
    /**
     * @file Adds [h] to bbcode
     * @example [h]content[/h]
     */
    const h = (node) => {
      return toNode( "h1", { class: "bb-header" }, node.content);
    };

    const h2 = (node) => {
      return toNode( "h2", { class: "bb-header-2"}, node.content);
    };

    const h3 = (node) => { 
      return toNode( "h3", { class: "bb-header-3" }, node.content);
    };

    const h4 = (node) => { 
      return toNode( "h4", { class: "bb-header-4" }, node.content);
    };

    const h5 = (node) => {
      return toNode( "h5", { class: "bb-header-5" }, node.content);
    };

    const h6 = (node) => {
      return toNode( "h6", { class: "bb-header-6" }, node.content);
    };
